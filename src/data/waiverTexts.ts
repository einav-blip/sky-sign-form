...
אני מצהיר/ה כי קראתי והבנתי את האמור לעיל וברור לי שאני זכאי/ת לבחור לבטל או לדחות את הצניחה בלי כל חיוב כספי מכך.`
    ...
    waiverDeclaration: {
      ...
      content: `אני הח"מ _______ נושא/ת ת"ז מס': ___________________________ תאריך לידה: __________________ מצהיר/ה כי:

• פניתי לחברת פרדייבאייר בע"מ (להלן: "החברה") בבקשה להשתתף בפעילות הצניחה החופשית ובשאר פעילויות שונות שעושה החברה (להלן: "פעילות החברה"). יובהר כי פעילות החברה מתייחסת גם לשימוש במטוסים, בציוד הצניחה וביתר המתקנים והאביזרים. פעילות החברה עשויה להתקיים בכל מקום לרבות בשטחה ו/או מחוצה לו.
